...
int main(void)
{
    ...
    // if (setsockopt(serverFd, SOL_SOCKET, SO_RCVTIMEO, (struct timeval *)&tv, sizeof(struct timeval)))
    // {
    //     printf("setsockopt : %s\n", strerror(errno));
    //     exit(EXIT_FAILURE);
    // }
