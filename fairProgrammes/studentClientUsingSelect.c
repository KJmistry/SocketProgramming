...
int main(void)
{
    int status, clientFd, switchCase, rollNo, deleteRollNum, updateRollNum, valid, clientID;
    ...
    while(1)
    {
        printf("Please enter your client ID (0, 1)\n");
        if (1 != scanf("%d", &clientID))
        {
    ...
    while (1)
    {
        ...
        case ADD:
            ...
            */
            ...
            snprintf(finalData, FINAL_DATA_BUFFER_SIZE, "%d1%s%c%d%c", clientID, studentName, specialCharacter, rollNo, null);
        ...
        case DELETE:
            ...
            */
            ...
            snprintf(finalData, FINAL_DATA_BUFFER_SIZE, "%d2%d%c", clientID, deleteRollNum, null);
            printf("Final Frame Generated : %s\n", finalData);
            break;
        ...
        case UPDATE:
            ...
            */
            ...
            snprintf(finalData, FINAL_DATA_BUFFER_SIZE, "%d3%d%c%s%c%d%c", clientID, updateRollNum, specialCharacter, studentName, specialCharacter, rollNo, null);
            printf("Final Frame Generated : %s\n", finalData);
            break;
        ...
        valid = send(clientFd, finalData, strlen(finalData) + 1, MSG_NOSIGNAL);
